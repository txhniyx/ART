	...
	<div>
		<h1>Customers Details</h1>  
		   ...
		   <form action="AddCustomer" method="post" >
			...
			String query= "select title from painting";
			try
			{
			...
			<div>
		      ...
		      <label for="EmailID">
		      	...
		      	<input type="text" id="EmailID" name="EmailID" value="" placeholder="Email Address" tabindex="6" required="required"  />
		      </label>  
			</div>
                        <div>
		      <label for="Password">
		      	<span class="required">Password: </span>
		      	<input type="password" id="Password" name="Password" value="" placeholder="Password" tabindex="7" required="required"  />
		      </label>  
			</div>
