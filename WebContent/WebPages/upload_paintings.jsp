...
/* General Styles */
body { 
     background: url('images/3-Panels-Painted-font-b-Ocean-b-font-font-b-Waves-b-font-Oil-font-b.jpg') no-repeat center center fixed;    
    ...
    <header class="user__header">
        <h2 class="user__title">Upload your Painting Information </h2>
    </header>
