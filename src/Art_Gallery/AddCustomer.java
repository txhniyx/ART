...
public class AddCustomer extends HttpServlet {
    ...
    try{  
     ...
     conn = DriverManager.getConnection(url+dbName,"root", "mypass");
      ...
      PreparedStatement pst =(PreparedStatement) conn.prepareStatement("insert into customer (c_id, c_name, address, phone,email,pass) values(?,?,?,?,?,?)");//try2 is the name of the table  
